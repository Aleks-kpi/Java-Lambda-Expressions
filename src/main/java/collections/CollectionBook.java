...
public class CollectionBook {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("Miss Peregrine's Home for Peculiar Children", "Ranson",
                "Riggs", 382);
        Book book2 = new Book("Harry Potter and The Sorcerers Stone", "JK",
                "Rowling", 411);
        Book book3 = new Book("The Cat in the Hat", "Dr",
                "Seuss", 45);
        ...
        List<Book> dupBook = asList(book1, book2, book3, book1, book2);
