...
public class MethodsAsLambda {
    public static void main(String[] args) {
        ...
        System.out.println("expected value 4, actual value: " + intToSTring2.apply(1234).length());
        ...
        // example of a lambda made from instance method
